...
$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            case "5/5": titulo = "30 de Abril de 2023"; mensagem = "<p>Esse foi o dia que fomos assistir um 'filme' na casa da Vanessa.</p><p>Foi incrivel, fizemos muitas coisas e percebi o quanto tava gostando de vc,e tava desconfiando que vc tava querendo ficar comigo.</p><p>E eu estava certo, no mesmo dia quando a francine fez a pergunta na roda se ficaria com alguem da roda vc bebeu sendoque os unicos solteiros ali era eu e vc,era para eu ter te puxado e dar um beijo ja naquele momento mas fui lerdo errei,fui mlk KKKKK!</p>";break;
            ...
            case "19/6": titulo = "05 de janeiro de 2024"; mensagem = "<p>A esse dia foi uma emoção q so,primeiro saimos para tomar sorvete, e na volta vemos uma briga de bar e um cara com uma arma ,qur dizer vc viu KKKKK e corremos ,quanta adrenalina para um dia só , e por fim ainda falou que a vida de solteiro ta chata ,ai que dia incrivel seriooooo.</p>";break;
            case "5/6": titulo = "17 de fevereiro de 2024"; mensagem = "<section class='text-center'><p class='letra-vermelha'><strong>OHHHH bobinha, isso eh hj e este momento está sendo escrito agora...</strong></p></section>";break;
            case "final": titulo = "17 de Fevereiro de 2024"; mensagem = "<section class='text-center mt-5 mb-5'><p><strong>O dia em que ela disse<br><span class='letra2 letra-vermelha'>SIM</span></strong></p></section>";break;
        }
